# 🏗️ Guide Technique Unifié RooSync v2.1
...
2. [Architecture v2.1](#2-architecture-v21)
...
1.  **Déploiement Généralisé** : Mise à jour de tous les agents vers la v2.1.
...
Le `BaselineService` est le cœur de l'architecture baseline-driven v2.1. Il gère :
...
// Message envoyé : "v2.1.0" au lieu de "v2.1.1"

// 3. Amendement rapide
await use_mcp_tool('roo-state-manager', 'roosync_amend_message', {
  messageId: "msg-20251027-120000-abc1",
  amendments: {
    body: "Le baseline complete v2.1.1 est prêt pour synchronisation.",
    metadata: {
      baselineVersion: "v2.1.1"
    }
  },
...
// Résultat : Message contient la version corrigée "v2.1.1"
```
...
#### Pour cette machine
1. **Immédiat** :
   - Valider baseline v2.1.0 complet
