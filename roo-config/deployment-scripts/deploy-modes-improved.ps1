# Script de deploiement des modes simples/complex pour Roo (Version amelioree)
# Cette version utilise un script de correction d'encodage ameliore
...
Write-ColorOutput "   (Version amelioree)" "Cyan"
...
# Etape 1: Utiliser le script fix-encoding-improved.ps1 pour corriger l'encodage
Write-ColorOutput "`nEtape 1: Application de la correction d'encodage amelioree..." "Magenta"

$fixEncodingScript = Join-Path -Path $scriptDir -ChildPath "..\encoding-scripts\fix-encoding-improved.ps1"
