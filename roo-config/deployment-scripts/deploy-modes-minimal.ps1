# Script de deploiement minimal des modes simples/complex pour Roo
# Cette version utilise le script de correction d'encodage minimal
...
Write-Host "   (Version minimale)" -ForegroundColor Cyan
...
# Etape 1: Utiliser le script fix-encoding-minimal.ps1 pour corriger l'encodage
Write-Host "`nEtape 1: Application de la correction d'encodage minimale..." -ForegroundColor Magenta

$fixEncodingScript = Join-Path -Path $scriptDir -ChildPath "..\encoding-scripts\fix-encoding-minimal.ps1"
