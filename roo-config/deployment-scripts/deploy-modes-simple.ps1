# Script de deploiement des modes simples/complex pour Roo (Version simplifiee)
# Cette version utilise un script de correction d'encodage simplifie
...
Write-ColorOutput "   (Version simplifiee)" "Cyan"
...
# Etape 1: Utiliser le script fix-encoding-simple.ps1 pour corriger l'encodage
Write-ColorOutput "`nEtape 1: Application de la correction d'encodage simplifiee..." "Magenta"

$fixEncodingScript = Join-Path -Path $scriptDir -ChildPath "..\encoding-scripts\fix-encoding-simple.ps1"
