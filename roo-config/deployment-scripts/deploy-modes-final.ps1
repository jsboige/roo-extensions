# Script de deploiement final des modes simples/complex pour Roo
# Cette version utilise le script de correction d'encodage final
...
Write-Host "   (Version finale)" -ForegroundColor Cyan
...
# Etape 1: Utiliser le script fix-encoding-final.ps1 pour corriger l'encodage
Write-Host "`nEtape 1: Application de la correction d'encodage finale..." -ForegroundColor Magenta

$fixEncodingScript = Join-Path -Path $scriptDir -ChildPath "..\encoding-scripts\fix-encoding-final.ps1"
