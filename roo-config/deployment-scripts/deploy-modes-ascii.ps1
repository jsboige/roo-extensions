# Script de deploiement ASCII des modes simples/complex pour Roo
# Cette version utilise le script de correction d'encodage ASCII
...
Write-Host "   (Version ASCII)" -ForegroundColor Cyan
...
# Etape 1: Utiliser le script fix-encoding-ascii.ps1 pour corriger l'encodage
Write-Host "`nEtape 1: Application de la correction d'encodage ASCII..." -ForegroundColor Magenta

$fixEncodingScript = Join-Path -Path $scriptDir -ChildPath "..\encoding-scripts\fix-encoding-ascii.ps1"
