...
$pathMappings = @{
    'Join-Path -Path $scriptPath -ChildPath "recommended-config.json"' = 'Join-Path -Path (Split-Path -Parent $scriptPath) -ChildPath "configs\escalation\recommended-config.json"'
    'Join-Path -Path $scriptPath -ChildPath "..\test-results"' = 'Join-Path -Path (Split-Path -Parent $scriptPath) -ChildPath "test-results"'
    'Join-Path -Path $scriptPath -ChildPath "..\test-data"' = 'Join-Path -Path (Split-Path -Parent $scriptPath) -ChildPath "test-data"'
...
$logsDir = "scripts/escalation/logs/escalation"
$reportsDir = "scripts/escalation/reports"
