...
**Version:** 3.0.0 (slim, procédure technique déportée 2026-05-19)
**MAJ:** 2026-04-27
...
**Procédure complète (healthcheck commands, architecture chain, diagnostic par couche, watchdog) :** [`docs/harness/reference/mcp-diagnosis-procedure.md`](../../docs/harness/reference/mcp-diagnosis-procedure.md)
