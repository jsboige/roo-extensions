...
**Historique des Incidents :** Voir [`.claude/rules/reference/incident-history.md`](reference/incident-history.md) (liste complète des incidents et leçons apprises).
