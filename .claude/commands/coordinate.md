...
### Wakeup Cycle Cadence (coordinateur ai-01 **3h** depuis 2026-09-09 ; executeurs **4h**)

**Cadence coordinateur ai-01 : 3h via `CronCreate`** (décision user 2026-09-09, « réarmer un cron de 3h », minute :23 conservée). Supersede le 2h du 2026-09-08 (« réarmer un cron de 2h »), le 3h du 2026-09-07 (« augmente la fréquence de ton cron à 3h », mandat dispatch massif), le 4h du 2026-09-06, le 8h du 2026-09-03, le 4h du mandat 2026-08-15/17, la 2h (#2203/2026-05-25) et la 6h. `ScheduleWakeup` est clampé runtime à `[60, 3600]s` (max 1h) → il ne PEUT PAS porter un cycle multi-heures ; le 3h passe donc par cron.
...
> **Portée : la flotte n'est PLUS alignée, et c'est délibéré.** Le coordinateur passe à **3h** ; les cinq exécuteurs (po-2023/24/25/26, web1) restent à **4h** sur `/executor` (`.claude/skills/executor/SKILL.md`). Un coordinateur plus rapide que ses exécuteurs est la bonne asymétrie : il produit les dispatchs, ils les consomment — une file légèrement en avance vaut mieux qu'une lane qui se réveille les mains vides. Ne PAS « corriger » cet écart en réalignant. Minutes décalées (:23 coord, :41 exécuteurs) pour ne pas frapper l'API en même temps. Les deux cadences partagent une **heure** deux fois par jour — coord tire à 00/03/06/09/12/15/18/21, exécuteurs à 00/04/08/12/16/20, intersection = {00, 12} — et le décalage de minute suffit alors.
...
**Limite quotidienne** : Maximum **24 self-merges/24h** sans validation user (relevé de 12 → 24, mandat user 2026-07-03, régime cron coord 3h + production continue ; pointer-bumps mécaniques). Au-delà → poster `[ASK]` dashboard pour approbation explicite. Les RED FLAGS absolus ci-dessus restent le vrai garde-fou, indépendamment du compte.
