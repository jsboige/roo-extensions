...
### Wakeup Cycle Cadence (**4h** partout : executeurs et coordinateur ai-01, depuis 2026-09-06)

**Cadence coordinateur ai-01 : 4h via `CronCreate`** (décision user 2026-09-06, « réarmer un cron de coordination 4h »). Supersede le 8h du 2026-09-03, qui superseda lui-meme le 4h du mandat 2026-08-15/17, la 2h (#2203/2026-05-25) et la 6h. `ScheduleWakeup` est clampé runtime à `[60, 3600]s` (max 1h) → il ne PEUT PAS porter un cycle multi-heures ; le 4h passe donc par cron.
...
> **Portée : toute la flotte est désormais alignée à 4h.** Les cinq exécuteurs (po-2023/24/25/26, web1) étaient déjà à **4h** sur `/executor` (`.claude/skills/executor/SKILL.md`) ; ai-01 les rejoint. Les minutes restent décalées (:23 coord, :41 exécuteurs) pour ne pas frapper l'API en même temps.
