---
description: Switch between Anthropic, z.ai, Claudish hybrid, or subscription-free Claudish proxy
argument-hint: anthropic | zai | claudish | claudish-proxy
...
Run with: `/switch-provider anthropic`, `/switch-provider zai`, `/switch-provider claudish`, or `/switch-provider claudish-proxy`
