...
- Deleguer a code-simple via `new_task` avec contexte worktree : "Executer `git pull --no-rebase origin main` pour mettre a jour le code (TOUJOURS --no-rebase pour preserver l'historique)"
