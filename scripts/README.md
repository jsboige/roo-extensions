...
| `claude/test-glm-context.ps1` | Teste la taille réelle de la fenêtre de contexte GLM via l'API configurée en envoyant des prompts de taille croissante avec un code secret, afin de détecter une troncature silencieuse |
