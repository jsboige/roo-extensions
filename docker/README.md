...
| roo-state-manager | `POST /roo-state-manager/mcp` | 17 outils (conversation_browser, codebase_search, roosync_*, etc. post all CONS) — upstream HTTP vers service host (voir `docs/harness/reference/mcp-proxy-host.md`) |
